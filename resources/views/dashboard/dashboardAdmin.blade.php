...
@section('content')
    <div class="container-fluid">
        ...
        <!-- FILTER SECTION -->
        <form method="GET" class="row g-3 mb-4 shadow-sm p-2 bg-white rounded d-flex justify-content-end">
            <div class="col-md-4">
                                                ...
                                                @php
                                                    $groupedData = collect($dataProductionsAll)
                                                        ->filter(function ($item) use ($group) {
                                                            return $item->reportApproval->approval_id ==
                                                                $group['leader_id'];
                                                        })
                                                        ->groupBy(function ($item) {
                                                            return $item->reportApproval->report->name;
                                                        })
...
@section('scripts')
    ...
    <script>
        ...
        // Sesuaikan ukuran bar berdasarkan jumlah data
